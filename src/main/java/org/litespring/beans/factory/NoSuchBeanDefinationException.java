...
public class NoSuchBeanDefinationException extends BeanException {
     ...
     */
    public NoSuchBeanDefinationException(String name) {
     ...
     */
    public NoSuchBeanDefinationException(String name, String message) {
     ...
     */
    public NoSuchBeanDefinationException(Class<?> type) {
     ...
     * @param message detailed message describing the problem
     */
    public NoSuchBeanDefinationException(Class<?> type, String message) {
     ...
     * @param message detailed message describing the problem
     */
    public NoSuchBeanDefinationException(Class<?> type, String dependencyDescription, String message) {
